...
pub struct InitUserMetadata {
    ...
    pub user_metadata: solana_address::Address,

    pub referrer_user_metadata: Option<solana_address::Address>,
...
impl InitUserMetadata {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitUserMetadataInstructionData::new().try_to_vec().unwrap();
...
pub struct InitUserMetadataInstructionArgs {
    pub user_lookup_table: Address,
}

impl InitUserMetadataInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct InitUserMetadataBuilder {
    ...
    user_metadata: Option<solana_address::Address>,
    referrer_user_metadata: Option<solana_address::Address>,
    rent: Option<solana_address::Address>,
    system_program: Option<solana_address::Address>,
    user_lookup_table: Option<Address>,
...
impl InitUserMetadataBuilder {
    ...
    #[inline(always)]
    pub fn user_metadata(&mut self, user_metadata: solana_address::Address) -> &mut Self {
        self.user_metadata = Some(user_metadata);
        self
    }
    /// `[optional account]`
    #[inline(always)]
    pub fn referrer_user_metadata(
        &mut self,
        referrer_user_metadata: Option<solana_address::Address>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn user_lookup_table(&mut self, user_lookup_table: Address) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = InitUserMetadataInstructionArgs {
            user_lookup_table: self
                .user_lookup_table
                .clone()
                .expect("user_lookup_table is not set"),
        };
...
impl<'a, 'b> InitUserMetadataCpiBuilder<'a, 'b> {
    ...
    pub fn user_metadata(
        &mut self,
        user_metadata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitUserMetadataCpi {
            ...
            user_metadata: self
                .instruction
                .user_metadata
                .expect("user_metadata is not set"),
