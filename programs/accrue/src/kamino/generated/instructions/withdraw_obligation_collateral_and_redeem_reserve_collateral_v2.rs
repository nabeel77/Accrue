...
pub struct WithdrawObligationCollateralAndRedeemReserveCollateralV2 {
    ...
    pub withdraw_reserve: solana_address::Address,

    pub reserve_liquidity_mint: solana_address::Address,

    pub reserve_source_collateral: solana_address::Address,
...
pub struct WithdrawObligationCollateralAndRedeemReserveCollateralV2Builder {
    ...
    withdraw_reserve: Option<solana_address::Address>,
    reserve_liquidity_mint: Option<solana_address::Address>,
    reserve_source_collateral: Option<solana_address::Address>,
...
impl WithdrawObligationCollateralAndRedeemReserveCollateralV2Builder {
    ...
    #[inline(always)]
    pub fn withdraw_reserve(&mut self, withdraw_reserve: solana_address::Address) -> &mut Self {
    ...
    pub fn reserve_source_collateral(
        &mut self,
        reserve_source_collateral: solana_address::Address,
    ) -> &mut Self {
...
impl<'a, 'b> WithdrawObligationCollateralAndRedeemReserveCollateralV2CpiBuilder<'a, 'b> {
    ...
    pub fn withdraw_reserve(
        &mut self,
        withdraw_reserve: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn reserve_source_collateral(
        &mut self,
        reserve_source_collateral: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
