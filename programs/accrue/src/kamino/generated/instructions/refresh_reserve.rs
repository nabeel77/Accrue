...
pub struct RefreshReserve {
    ...
    pub pyth_oracle: Option<solana_address::Address>,

    pub switchboard_price_oracle: Option<solana_address::Address>,

    pub switchboard_twap_oracle: Option<solana_address::Address>,
...
impl RefreshReserve {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = RefreshReserveInstructionData::new().try_to_vec().unwrap();
...
pub struct RefreshReserveBuilder {
    ...
    pyth_oracle: Option<solana_address::Address>,
    switchboard_price_oracle: Option<solana_address::Address>,
    switchboard_twap_oracle: Option<solana_address::Address>,
...
impl RefreshReserveBuilder {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn pyth_oracle(&mut self, pyth_oracle: Option<solana_address::Address>) -> &mut Self {
        self.pyth_oracle = pyth_oracle;
        self
    }
    /// `[optional account]`
    #[inline(always)]
    pub fn switchboard_price_oracle(
        &mut self,
        switchboard_price_oracle: Option<solana_address::Address>,
    ) -> &mut Self {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn switchboard_twap_oracle(
        &mut self,
        switchboard_twap_oracle: Option<solana_address::Address>,
    ) -> &mut Self {
