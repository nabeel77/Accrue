...
pub const DEPOSIT_RESERVE_LIQUIDITY_AND_OBLIGATION_COLLATERAL_DISCRIMINATOR: [u8; 8] =
...
pub struct DepositReserveLiquidityAndObligationCollateral {
    ...
    pub reserve_collateral_mint: solana_address::Address,

    pub reserve_destination_deposit_collateral: solana_address::Address,

    pub user_source_liquidity: solana_address::Address,

    pub placeholder_user_destination_collateral: Option<solana_address::Address>,
...
impl DepositReserveLiquidityAndObligationCollateral {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DepositReserveLiquidityAndObligationCollateralInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl DepositReserveLiquidityAndObligationCollateralInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct DepositReserveLiquidityAndObligationCollateralBuilder {
    ...
    reserve_collateral_mint: Option<solana_address::Address>,
    reserve_destination_deposit_collateral: Option<solana_address::Address>,
    user_source_liquidity: Option<solana_address::Address>,
    placeholder_user_destination_collateral: Option<solana_address::Address>,
...
impl DepositReserveLiquidityAndObligationCollateralBuilder {
    ...
    pub fn reserve_collateral_mint(
        &mut self,
        reserve_collateral_mint: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn reserve_destination_deposit_collateral(
        &mut self,
        reserve_destination_deposit_collateral: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn liquidity_token_program(
        &mut self,
        liquidity_token_program: solana_address::Address,
    ) -> &mut Self {
...
impl<'a, 'b> DepositReserveLiquidityAndObligationCollateralCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(
            DepositReserveLiquidityAndObligationCollateralCpiBuilderInstruction {
                __program: program,
                owner: None,
                obligation: None,
                lending_market: None,
    ...
    pub fn reserve_collateral_mint(
        &mut self,
        reserve_collateral_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn reserve_destination_deposit_collateral(
        &mut self,
        reserve_destination_deposit_collateral: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn liquidity_token_program(
        &mut self,
        liquidity_token_program: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
