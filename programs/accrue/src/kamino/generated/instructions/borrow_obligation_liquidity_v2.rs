...
pub const BORROW_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR: [u8; 8] =
...
impl BorrowObligationLiquidityV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BorrowObligationLiquidityV2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl BorrowObligationLiquidityV2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
