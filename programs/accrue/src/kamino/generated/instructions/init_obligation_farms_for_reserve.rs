...
pub const INIT_OBLIGATION_FARMS_FOR_RESERVE_DISCRIMINATOR: [u8; 8] =
...
pub struct InitObligationFarmsForReserve {
    ...
    pub reserve_farm_state: solana_address::Address,

    pub obligation_farm: solana_address::Address,
...
impl InitObligationFarmsForReserve {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitObligationFarmsForReserveInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InitObligationFarmsForReserveInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct InitObligationFarmsForReserveBuilder {
    ...
    obligation_farm: Option<solana_address::Address>,
...
impl InitObligationFarmsForReserveBuilder {
    ...
    #[inline(always)]
    pub fn reserve_farm_state(&mut self, reserve_farm_state: solana_address::Address) -> &mut Self {
        self.reserve_farm_state = Some(reserve_farm_state);
        self
    }
    #[inline(always)]
    pub fn obligation_farm(&mut self, obligation_farm: solana_address::Address) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = InitObligationFarmsForReserve {
            ...
            reserve_farm_state: self
                .reserve_farm_state
                .expect("reserve_farm_state is not set"),
...
impl<'a, 'b> InitObligationFarmsForReserveCpiBuilder<'a, 'b> {
    ...
    pub fn reserve_farm_state(
        &mut self,
        reserve_farm_state: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.reserve_farm_state = Some(reserve_farm_state);
        self
    }
    #[inline(always)]
    pub fn obligation_farm(
        &mut self,
        obligation_farm: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitObligationFarmsForReserveCpi {
            ...
            obligation_farm: self
                .instruction
                .obligation_farm
                .expect("obligation_farm is not set"),
